...
function CardList() {
    return (
        <div className="cardList">
            <Card link={link1} title="title 1" desc="this is desc 1 " price = {1000}/>
            <Card link={link1} desc="this is desc 2 " price = {230} />
            <Card link={link2} title="title 2" desc="this is desc 3 " price={544} />
        </div>
    )
}
